...
func (w Walking) Calories() float64 {
	...
	height := w.Height * 100
	calories := (CaloriesWeightMultiplier*w.Weight + (math.Pow(speed, 2)/height)*CaloriesSpeedHeightMultiplier*
		w.Weight) * w.Duration.Hours() * MinInHours
	return calories
}
...
func (s Swimming) Calories() float64 {
	calories := (s.meanSpeed() + SwimmingCaloriesMeanSpeedShift) * SwimmingCaloriesWeightMultiplier *
